...
import 'package:hali_saha_bak/screens/Hs/EditHaliSaha/abonelik_ekle.dart';
...
class HaliSahaWidgetTwo extends StatelessWidget {
  const HaliSahaWidgetTwo({
    Key? key,
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => isGuest
                ...
                : isHaliSaha
                ? EditHaliSahaTwo(haliSaha: haliSaha)
                : UserHaliSahaDetail(
              haliSaha: haliSaha,
            ),
          ),
