...
class MyHaliSahas extends StatefulWidget {
  const MyHaliSahas({Key? key}) : super(key: key);

  @override
  State<MyHaliSahas> createState() => _MyHaliSahasState();
}

class _MyHaliSahasState extends State<MyHaliSahas> {
  User? user;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Halı Sahalarım'),
      ),
      body: SafeArea(
  ...
  Column buildVerifyEmailScreen(BuildContext context) {
    return Column(
      ...
      children: [
        const Center(
          child: Text('Devam edebilmek için hesabınızın onaylanmasını bekleyiniz'),
        ),
        Padding(
